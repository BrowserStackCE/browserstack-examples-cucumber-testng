    ...
    stage('Build') {
      ...
      def notifySlack(String buildStatus = 'STARTED') {
          ...
          //if (buildStatus != 'STARTED' && buildStatus !='SUCCESS') {
              ...
              slackUploadFile channel: 'vgm', filePath: 'var/jenkins_home/workspace/cucumberreporting/reports/tests/cucumber/json/cucumber.json', initialComment: 'Here is the report'
          //}
 }
